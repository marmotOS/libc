...
// NOTE:
// ctype tables are indexed by adding 1 to index
// so that EOF indexes to zero
...
{
    return (_ctype[x+1] & (_U | _L));
}


int isalnum(const int x)
{
    return (_ctype[x+1] & (_D | _U | _L));
}


int iscntrl(const int x)
{
    return (_ctype[x+1] & (_B | _C));
}


int isdigit(const int x)
{
    return (_ctype[x+1] & _D);
}


int isgraph(const int x)
{
    return (_ctype[x+1] & (_D | _L | _U | _P));
}


int islower(const int x)
{
    return (_ctype[x+1] & _L);
}


int isprint(const int x)
{
    return (_ctype[x+1] & (_D | _L | _U | _P | _S));
}


int ispunct(const int x)
{
    return (_ctype[x+1] & _P);
}


int isspace(const int x)
{
    return (_ctype[x+1] & (_S | _C));
}


int isupper(const int x)
{
    return (_ctype[x+1] & _U);
}


int isxdigit(const int x)
{
    return (_ctype[x+1] & (_X | _D));
}
